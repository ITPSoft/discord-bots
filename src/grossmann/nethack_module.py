...
async def start_nethack():
    ...
    nethack_proc = pexpect.spawn(NETHACK_PATH, encoding="cp437", dimensions=(NETHACK_ROWS, NETHACK_COLS), env=env)
...
def render_pyte_to_image(
    screen, font_path="/usr/share/fonts/truetype/dejavu/DejaVuSansMono.ttf", font_size=16, padding=8
):
